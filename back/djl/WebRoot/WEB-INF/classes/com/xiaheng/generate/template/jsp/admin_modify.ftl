						...
						<form class="layui-form" action="">
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="${l.columnName}" <c:if test="${r"${op eq 'see'}"}">disabled="disabled"</c:if>
										value="${r'${v.'}${l.columnName}${r'}'}" placeholder="请输入${l.comment}名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
