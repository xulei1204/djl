							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="code" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.code}" placeholder="请输入银行卡号名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							
							<div class="layui-form-item">
								<label class="layui-form-label">银行id</label>
								<div class="layui-input-block">
									<input type="text" name="bankId" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.bankId}" placeholder="请输入银行id名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
