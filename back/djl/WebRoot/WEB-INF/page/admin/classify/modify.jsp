					...
					<div class="ibox-content layui-form">
						<form class="layui-form" action="">
							<input type="hidden" name="id" value="${v.id}" class="layui-input">								
								...
								<div class="layui-form-item">
									<label class="layui-form-label">图片</label>
									<div class="layui-input-block">
										<img alt="暂无图片" src="${v.pic}" id="icon" style="width: 200px;height: 200px">
									</div>
								</div>
								...
								<div class="layui-input-block">
									<input type="text" name="title" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.title}" placeholder="请输入类目名称"    autocomplete="off"
										class="layui-input">
								</div>
							</div>
						...
						<script type="text/javascript">
							...
							layui.use(['form','upload'], function() {
								...
								data.field.icon = $('#icon').attr("src");
								var title=data.field.title;
								if(title==null||title==""||title==undefined){
										swalTip("警告","请输入类目名称！",false);
										return false;
								}
								
								ajaxPOST("modify/classify", {
