				...
				<div class="ibox float-e-margins">
					<div class="ibox-content layui-form">
						<form class="layui-form" action="">
							...
							<div class="layui-form-item">
								<label class="layui-form-label">红包id</label>
								<div class="layui-input-block">
									<input type="text" name="redId" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.redId}" placeholder="请输入红包id名称" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
						...
						<script type="text/javascript">
							...
							layui.use('form', function() {
								...
								form.on('submit(form)', function(data) {
									ajaxPOST("modify/redpacketRecord", {
