							...
							<input type="hidden" name="id" value="${v.id}" class="layui-input">
								...
								<div class="layui-form-item">
									...
									<div class="layui-input-block">
										<input type="file" accept="image/jpg,image/png,image/jpeg" name="value" class="layui-upload-file">
									</div>
								</div>
								...
								<div class="layui-form-item">
									<label class="layui-form-label">图片</label>
									<div class="layui-input-block">
										<img alt="暂无图片" src="${v.value }" id="pic" style="width: 400px;height: 300px">
									</div>
								</div>
