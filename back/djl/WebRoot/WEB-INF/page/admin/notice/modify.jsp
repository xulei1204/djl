							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="title" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.title}" placeholder="请输入标题" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
							...
							<div class="layui-form-item">
								...
								<div class="layui-input-block">
									<input type="text" name="content" <c:if test="${op eq 'see'}">disabled="disabled"</c:if>
										value="${v.content}" placeholder="请输入内容" required  lay-verify="required" autocomplete="off"
										class="layui-input">
								</div>
							</div>
